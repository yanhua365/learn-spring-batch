package com.yanhua365.learn.spring.batch.multi_threads_step;
...
public class Application {
    ...
    public DataSource getH2ServerDataSource(){
        return new SimpleDriverDataSource(new Driver(), "jdbc:h2:tcp://localhost/~/h2data/batch-multi_threads_step", "sa", "");
    }
